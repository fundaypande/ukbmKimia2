    ...
    return (
      <Grid style={{ height: 300 }}>
        ...
        <Col size={68}>
          ...
          <Row style={funStyle.funTable}>
            <T t='Apakah kalian telah memahami materi senyawa hidrokarbon?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menganalisis struktur dan sifat senyawa hidrokarbon berdasarkan kekhasan atom karbon dan penggolongan senyawanya?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian membuat model visual berbagai struktur molekul hidrokarbon yang memiliki rumus molekul yang sama?' />
          </Row>
        </Col>
        <Col size={12}>
          <Row style={funStyle.funTableH}>
      ...
      <View style={funStyle.funContainer}>
        ...
        <View style={{ flex: 1 }}>
          <ScrollView style={{ paddingLeft: 10, paddingRight: 10 }}>
            ...
            <View style={funStyle.funSpace} />
            <View style={funStyle.funSpace} />
            <T t='Setelah kalian belajar bertahap dan berlanjut melalui kegiatan belajar Senyawa Hidrokarbon, berikut diberikan Tabel untuk mengukur diri kalian terhadap materi yang sudah kalian pelajari. Jawablah sejujurnya terkait dengan penguasaan materi pada UKBM ini di Tabel berikut. ' />
            <View style={funStyle.funSpace} />
