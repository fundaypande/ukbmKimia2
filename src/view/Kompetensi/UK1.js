      ...
      <View style={funStyle.funContainer}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={funStyle.funFloat}>
            <T t='18.  ' />
            <View>
              <T t='18.	Adisi alkena dengan  air membutuhkan katalisator asam. Hasil reaksi mengikuti aturan Markonikov. Hasil reaksi: 1-propena  +  H2O adalah ....' />
          ...
          <View style={funStyle.funFloat}>
            <T t='19.  ' />
            <View>
              <T t='19.	Alkana yang tidak dapat dihasilkan dari adisi alkena adalah....' />
          ...
          <View style={funStyle.funFloat}>
            <T t='20.  ' />
            <View>
              <T t='20.	Reaksi oksidasi sempurna gas LPG (campuran gas metana, etana, dan propana) akan menghasilkan ….' />
