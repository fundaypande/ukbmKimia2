    ...
    return (
      <Grid style={{ height: 300 }}>
        ...
        <Col size={68}>
          ...
          <Row style={funStyle.funTable}>
            <T t='Apakah kalian telah memahami materi minyak bumi?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menjelaskan proses pembentukkan minyak bumi?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menjelaskan proses pemisahan fraksi minyak bumi?' />
          </Row>
        </Col>
        <Col size={12}>
          <Row style={funStyle.funTableH}>
