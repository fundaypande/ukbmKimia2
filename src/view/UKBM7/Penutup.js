    ...
    if (this.state.nilaiSiswa !== '') {
      if (this.state.y1 === 'true' && this.state.y2 === 'true' && this.state.y3 === 'true') {
        ...
        if (status) {
          ...
          const uid = users.uid;
          const dbRef = firebase.database().ref('users/' + uid + '/ukbm/ukbm7');
    ...
    return (
      <Grid style={{ height: 300 }}>
        ...
        <Col size={68}>
          ...
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menentukan persamaan laju reaksi?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menentukan tetapan laju reaksi? ' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menentukan orde reaksi?' />
          </Row>
        </Col>
        <Col size={12}>
          <Row style={funStyle.funTableH}>
      ...
      <View style={funStyle.funContainer}>
        ...
        <View style={{ flex: 1 }}>
          <ScrollView style={{ paddingLeft: 10, paddingRight: 10 }}>
            ...
            <View style={funStyle.funSpace} />
            <View style={funStyle.funSpace} />
            <T t='Setelah kalian belajar bertahap dan berlanjut melalui kegiatan belajar Laju Reaksi, berikut diberikan Tabel untuk mengukur diri kalian terhadap materi yang sudah kalian pelajari. Jawablah sejujurnya terkait dengan penguasaan materi pada UKBM ini di Tabel berikut. ' />
            <View style={funStyle.funSpace} />
