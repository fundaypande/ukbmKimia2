...
const bg_ukbm7 = require('./../../Assets/img/gambar_beranda_ukbm/ukbm7.jpg');


export default class UKBM7beranda extends React.Component {
  ...
  render() {
    ...
    <Header />
      ...
      <View style={styles.box2}>
        <Image source={Hukum_Laju} style={styles.iconHeaderUKBM} />
        <View style={styles.textUkbm}>
          <Text style={styles.textBox2}>  UKBM 7</Text>
          <Text style={styles.textBox2}>  Hukum Laju Reaksi dan Penentu Laju</Text>
        </View>
        </View>

        <View  style={styles.boxImage}>
            <Image source={bg_ukbm7} style={styles.imageUKBM}/>
        </View>
          <View style={styles.box3}>
             ...
             <TouchableOpacity style={styles.ButtonTengahStyle} onPress={() => this.props.navigation.navigate('Identitas7')}>
              ...
              <TouchableOpacity style={styles.ButtonTengahStyle} onPress={() => this.props.navigation.navigate('UKBM7_KB1')}>
