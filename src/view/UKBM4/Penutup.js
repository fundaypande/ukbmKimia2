    ...
    if (this.state.nilaiSiswa !== '') {
      if (this.state.y1 === 'true' && this.state.y2 === 'true' && this.state.y3 === 'true') {
        ...
        if (status) {
          ...
          const uid = users.uid;
          const dbRef = firebase.database().ref('users/' + uid + '/ukbm/ukbm4');
    ...
    return (
      <Grid style={{ height: 300 }}>
        ...
        <Col size={68}>
          ...
          <Row style={funStyle.funTable}>
            <T t='Apakah kalian telah memahami materi termokimia?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menjelaskan sistem dan lingkungan?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian membedakan reaksi eksoterm dan endoterm?' />
          </Row>
        </Col>
        <Col size={12}>
          <Row style={funStyle.funTableH}>
