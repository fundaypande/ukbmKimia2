...
const bg_ukbm4 = require('./../../Assets/img/gambar_beranda_ukbm/ukbm4.jpg');

const next_button = require('./../../Assets/img/next_button.png');
export default class UKBM4beranda extends React.Component {
  ...
  render() {
    ...
    <Header />
      ...
      <View style={styles.box2}>
        <Image source={Termokimia} style={styles.iconHeaderUKBM} />
        <View style={styles.textUkbm}>
          <Text style={styles.textBox2}>  UKBM 4</Text>
        ...
        <View  style={styles.boxImage}>
          ...
          <View style={styles.box3}>
             ...
             <TouchableOpacity style={styles.ButtonTengahStyle} onPress={() => this.props.navigation.navigate('Identitas4')}>
                  <Text style={styles.textButtonUKBM}> Identitas </Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.ButtonTengahStyle} onPress={() => this.props.navigation.navigate('Peta4')}>
                  <Text style={styles.textButtonUKBM}> Peta Konsep </Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.ButtonTengahStyle} onPress={() => this.props.navigation.navigate('Belajar4')}>
                  <Text style={styles.textButtonUKBM}> Informasi Pembelajaran </Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.ButtonTengahStyle} onPress={() => this.props.navigation.navigate('UKBM4_KB1')}>
                  <Text style={styles.textButtonUKBM}> Kegiatan Pembelajaran </Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.ButtonNextUKBM} onPress={() => this.props.navigation.navigate('UKBM5')}>
