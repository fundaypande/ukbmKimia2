...
const PK_UKBM4 = require('./../../Assets/peta_konsep/PK_UKBM4.png');



export default class PetaKonsepUKBM4 extends React.Component {

  backTo = () => {
     this.props.navigation.navigate('Identitas4');
   }
