...
const tabel = require('./../../Assets/UKBM7/ukbm7.png');

export default class KegiatanBelajarUKBM7 extends React.Component {
  ...
  backTo = () => {
   ...
   backTo2 = () => {
      this.props.navigation.navigate('UKBM7_KB1');
    }
                            ...
                            <View style={funStyle.funBigSpace} />
                                <View style={funStyle.funFloat}>
                                  <View style={funStyle.funNotifketeranganKegiatanBelajar}>
                                    <Text> Seorang ilmuan melakukan sebuah percobaan untuk mengukur laju reaksi untuk reaksi: 2A + B â†’ 2C. Dia melakukan percobaan sebanyak 4 kali dengan konsentrasi zat A dan B yang berbeda-beda. Dari percobaannya tersebut dia memperoleh data sebagai berikut.
                                    {'\n'}
                                    <Image source={tabel} />
                                    <Text style={funStyle.funNotifketeranganKegiatanBelajar}> {'\n'} Dari data percobaan diatas bagaimana persamaan laju reaksinya, serta berapakah orde reaksi total dan harga k dari reaksi tersebut?</Text>
                                    </Text>
                                  </View>
                                </View>
