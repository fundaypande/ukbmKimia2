...
const PK_UKBM3 = require('./../../Assets/peta_konsep/PK_UKBM3.png');



export default class PetaKonsepUKBM3 extends React.Component {

  backTo = () => {
     this.props.navigation.navigate('Identitas3');
   }
