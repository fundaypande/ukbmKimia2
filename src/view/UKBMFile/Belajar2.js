...
const LPG = require('./../../Assets/UKBM2/LPG.jpg');
                           ...
                           <View style={funStyle.funBigSpace} />
                                  ...
                                  <Image style={{ width: 100, height: 200 }} source={haikawan} />
                                    <View style={funStyle.funNotifMarikawan}>
                                      <Text style={funStyle.keteranganHayKawan}>Sebelum belajar pada materi ini silahkan kalian membaca dan memahami info tentang LPG di bawah ini.</Text>
                                    </View>
                                  </View>

                              <View style={funStyle.funBigSpace} />
                                  <View style={funStyle.funFloat}>
                                  <Image style={{ width: 130, height: 180, borderRadius: 20 }} source={LPG} />
                                    <View style={funStyle.funNotifketeranganKegiatanBelajar}>
                                      <Text><Text style={funStyle.bold}>LPG</Text> (liquified petroleum gas, harafiah: "gas minyak bumi yang dicairkan"). Dengan menambah tekanan dan menurunkan suhunya, gas berubah menjadi cair. Komponennya didominasi propana (C3H8) dan butana (C4H10).
                                      </Text>
                                    </View>
                                  </View>

                                  <View style={funStyle.funNotifketeranganKegiatanBelajar}>
                                    <Text>Elpiji juga mengandung hidrokarbon ringan lain dalam jumlah kecil, misalnya etana (C2H6) dan pentana (C5H12).{'\n'}
                                    ...
                                    Tekanan di mana elpiji berbentuk cair, dinamakan tekanan uap-nya, juga bervariasi tergantung komposisi dan temperatur; sebagai contoh, dibutuhkan tekanan sekitar 220 kPa (2.2 bar) bagi butana murni pada 20 Â°C (68 Â°F) agar mencair, dan sekitar 2.2 MPa (22 bar) bagi propana murni pada 55 Â°C (131 Â°F).
                                    Sumber: Wikipedia{'\n'}
                                    Bagaimana cara memperoleh minyak bumi dan mengolahnya menjadi LPG? Dapatkah LPG digunakan sebagai bahan bakar kendaraan ataupun pesawat terbang?
                                    </Text>
                                  </View>
