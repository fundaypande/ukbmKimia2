...
const PK_UKBM2 = require('./../../Assets/peta_konsep/PK_UKBM2.png');



export default class PetaKonsepUKBM2 extends React.Component {

  backTo = () => {
     this.props.navigation.navigate('Identitas2');
   }
