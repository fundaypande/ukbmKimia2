...
export default class UKBM1KB4 extends React.Component {
  ...
  /* 1. Navigate to the Details route with params */
    if (this.state.nilaiSiswa !== '') {
      if (this.state.y1 === 'true' && this.state.y2 === 'true' && this.state.y3 === 'true' && this.state.y4 === 'true' && this.state.y5 === 'true') {
        console.log('hasil nya akhir pencet : ' + this.state.totalNilai);
        let totalNilai = Number(this.state.totalNilai);
        let nilai = (totalNilai / fieldAll) * 100;
        let nilaiAkhir = Math.round(nilai * 100) / 100;
        ...
        if (status) {
          ...
          const uid = users.uid;
          const dbRef = firebase.database().ref('users/' + uid + '/ukbm/ukbm5');
    ...
    return (
      <Grid style={{ height: 300 }}>
        ...
        <Col size={68}>
          ...
          <Row style={funStyle.funTable}>
            <T t='Apakah kalian telah memahami materi Perubahan Entalpi dan Energi Ikatan?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menghitung perubahan entalpi berdasarkan hukum Hess?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menghitung perubahan entalpi berdasarkan data perubahan entalpi pembentukan standar?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menghitung perubahan entalpi berdasarkan percobaan kalorimeter?' />
          </Row>
          <Row style={funStyle.funTable}>
            <T t='Dapatkah kalian menghitung perubahan entalpi berdasarkan data energi ikatan?' />
          </Row>
        </Col>
        <Col size={12}>
          <Row style={funStyle.funTableH}>
          ...
          <Row style={funStyle.funTable}>
            <CheckBox checked={false} onChange={() => this.setState({ y4: 'true' })} />
          </Row>
          <Row style={funStyle.funTable}>
            <CheckBox checked={false} onChange={() => this.setState({ y5: 'true' })} />
          </Row>
        </Col>
        <Col size={12}>
          <Row style={funStyle.funTableH}>
      ...
      <View style={funStyle.funContainer}>
        ...
        <View style={{ flex: 1 }}>
          <ScrollView style={{ paddingLeft: 10, paddingRight: 10 }}>
            ...
            <View style={funStyle.funSpace} />
            <View style={funStyle.funSpace} />
            <T t='Setelah kalian belajar bertahap dan berlanjut melalui kegiatan belajar Perubahan Entalpi, berikut diberikan Tabel untuk mengukur diri kalian terhadap materi yang sudah kalian pelajari. Jawablah sejujurnya terkait dengan penguasaan materi pada UKBM ini di Tabel berikut. ' />
            <View style={funStyle.funSpace} />
