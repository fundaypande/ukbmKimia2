...
const bg_ukbm5 = require('./../../Assets/img/gambar_beranda_ukbm/ukbm5.jpg');

const next_button = require('./../../Assets/img/next_button.png');
export default class UKBM5beranda extends React.Component {
  ...
  render() {
    ...
    <Header />
      ...
      <View style={styles.box2}>
        <Image source={Perubahan_Entalpi} style={styles.iconHeaderUKBM} />
        <View style={styles.textUkbm}>
          <Text style={styles.textBox2}>  UKBM 5</Text>
          <Text style={styles.textBox2}>  Perubahan Entalphi dan Energi Ikatan</Text>
        </View>
        </View>
        <ScrollView>
        <View  style={styles.boxImage}>
            <Image source={bg_ukbm5} style={styles.imageUKBM}/>
        </View>
          <View style={styles.box3}>

             <TouchableOpacity style={styles.ButtonTengahStyle} onPress={() => this.props.navigation.navigate('Identitas5')}>
                  <Text style={styles.textButtonUKBM}> Identitas </Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.ButtonTengahStyle} onPress={() => this.props.navigation.navigate('Peta5')}>
                  <Text style={styles.textButtonUKBM}> Peta Konsep </Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.ButtonTengahStyle} onPress={() => this.props.navigation.navigate('Belajar5')}>
              ...
              <TouchableOpacity style={styles.ButtonNextUKBM} onPress={() => this.props.navigation.navigate('UKBM6')}>
